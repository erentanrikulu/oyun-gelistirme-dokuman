...
Bu proje, Python dili ve NLTK kütüphanesi kullanılarak doğal dil işleme (NLP) teknikleriyle oyun dokumanlarındaki çelişkilerini bulmayı amaçlamaktadır. Proje kapsamında veri ön işleme, metin temizliği ve temel NLP süreçleri uygulanmıştır.
...
ilk olarak oyun dokumanlarındaki verilerden ayrı ayrı veriler çekilmiştir daha sonra bu verilerin yorum sütunlarına ayrılmıştır. Gerekli olan verileri https://mikaelsegedi.blogspot.com/2015/02/game-design-document-from-famous-games.html buradan alabilirsiniz
Ayırılan yorum sütunlarını birleştirerek yeni bir md (asılveriler.md) dosyasına kaydedilmiştir.
yeni md dosyası üzerinde aşağıdaki işlemleri uyguladım.
-Bu çalışmam ise "doğal_dil_işleme-ipyn.ipyn" adlı kaynak dosyasında bulunmaktadır
...
md dosyasından alınan yorumlar şu adımlardan geçirilmiştir:
